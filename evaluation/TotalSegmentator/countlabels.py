...
SEG_PATH = "/scratch/VM/radio-foundation/preprocessed/TotalSegmentator/segmentations"
SPLITS_PATH = "evaluation/TotalSegmentator/splits"
OUTPUT_PATH = "evaluation/TotalSegmentator/output/counts.csv"
MAP_LABELS_PATH = "evaluation/TotalSegmentator/map_to_labels.json"

series_uids = [
    x.replace(".npy", "") for x in os.listdir(SEG_PATH) if x.endswith(".npy")
]

with open(MAP_LABELS_PATH, "r") as f:
