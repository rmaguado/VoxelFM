...
def discover_ts_series(root: Path) -> List[Job]:
...
if __name__ == "__main__":
    DATA_ROOT = "/scratch/VM/radio-foundation/preprocessed/TotalSegmentator"
    OUTPUT_PATH = (
        "/scratch/VM/radio-foundation/embeddings/DINO3D/TotalSegmentator/chp100k"
    )
    CONFIG_PATH = (
    ...
    series_paths = discover_ts_series(DATA_ROOT)
