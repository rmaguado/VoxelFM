...
if __name__ == "__main__":
    DATA_ROOT = "/scratch/VM/radio-foundation/essential/Merlin/merlinabdominalctdataset/merlin_data"
    OUTPUT_PATH = "/scratch/VM/radio-foundation/embeddings/DINO3D/Merlin/chp100k"
    CONFIG_PATH = (
